                    ...
                    @foreach ($competitions as $competition)
                        <tr class="hover:bg-TERTIARY border-b border-TERTIARY py-5">
                            <td class="px-4 py-2"><img
                                    src="{{ asset('storage/competition/logo/' . $competition->logo) }}"
                            ...
                            <td class="px-4 py-2"><i class="fas fa-eye"></i> {{ $competition->views ?? 0 }}</td>
                            <td class="px-4 py-2">
                            ...
                            <td class="px-4 py-2">{{ $competition->created_at->diffForHumans() }}</td>
                            <td class="px-4 py-2">
